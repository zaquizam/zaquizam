...
<%
'
' llenar_cmb_convivencias_x_cat.asp - 24may21 - 08jun21
'
Session.lcid = 1034
...
ELSEIF (Cint(opcion) = 4) THEN
	...
	'
	QrySql = vbnullstring
	QrySql = " SELECT DISTINCT Id_Segmento AS id, Segmento AS nombre FROM PH_DataCrudaMensual WHERE id_segmento <> 0  AND id_Categoria  = " & idCat & _
