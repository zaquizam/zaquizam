...
Sub DataCombos
	...
	sql = sql & " FROM PH_DataCruda INNER JOIN ss_ClienteCategoria ON PH_DataCruda.Id_Categoria = ss_ClienteCategoria.Id_Categoria "
	sql = sql & " WHERE "
	sql = sql & " ss_ClienteCategoria.Ind_Semanal = 1 "
	...
	sql = sql & " WHERE "
	if Session("perusu") = 5 or Session("perusu") = 7 then
		sql = sql & " Ind_Sem = 1 " 
	else
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					<!--Fabricante-->	
					 ...
					 <!--<img src="images/Select01.ico"  style="margin-left:0px;" title="Seleccionar Todos" alt="All" width="40px" onclick="TodoFab()"/>-->
				</div>
