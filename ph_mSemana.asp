...
' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Cod Semana"
   ed_sCampo(02,0)="Periodo"
   ed_sCampo(03,0)="Ano"
   ed_sCampo(04,0)="Mes"
   ed_sCampo(05,0)="Desde"
   ed_sCampo(06,0)="Hasta"
   ed_sCampo(07,0)="Ult Sem Mes?"
   ed_sCampo(08,0)="Descripcion"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(2,0)=  " SELECT IdPeriodo, Periodo FROM  ss_Periodo WHERE Fec_Inactivo is Null "
	...
	ed_Formato(01,0)="w3-col l1  w3-left w3-padding "
	...
	ed_Formato(08,0)="w3-col l3  w3-left w3-padding "
