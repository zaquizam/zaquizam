...
%>
	...
	function Procesar(){
		...
		//alert("Mes:=" + Mes);
		//return;
		var stodo = "cat=" + Cat + "&mes=" + Mes;
		document.getElementById("Programa").value = "g_ProcesamientoMensualMed.asp?" + stodo;
		//return;
		
		swal({
                title: "Desea Procesar esta Categoria en este Mes?",
                text: "",
                type: "warning",
            ...
            function() {
				...
				$.ajax({
					url:'g_ProcesamientoMensualMed.asp?'+stodo,
					...
					success:function(data){
						...
						$('#loader2').html('');
						console.log(data); 
						swal("Procesamiento Mensual","Categoria Procesada","success");
...
%>
	...
	'hidden 
	if idMes <> "Seleccionar" and  idCategoria <> "Seleccionar" then
