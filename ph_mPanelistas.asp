...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(1,0)=  " SELECT Id_Hogar, Persona_Contacto FROM  PH_Hogares WHERE Fec_Inactivo is Null "
	ed_sQue(8,0)=  " SELECT Id_Sexo, Sexo FROM  PH_Sexo WHERE Fec_Inactivo is Null "
	ed_sQue(9,0)=  " SELECT Id_Profesion, Profesion FROM  PH_Profesion WHERE Fec_Inactivo is Null "
