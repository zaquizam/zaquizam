<!DOCTYPE HTML>
<!-- ph_rRevInvestigaciones.asp // 13ene21 - 14ene21 -->
<html >
<head>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<div class="form-group">				
					...
					<!--<select class="form-control input-sm" title="Seleccionar Hogar" name="cboHogar" id="cboHogar" onchange="buscarDetallesxConsumo();" />-->
			...
			<div class="col-sm-2">
				<div class="form-group">				
					<label>Estado:</label>
					<input type="text" class="form-control input-sm" title="Area" name="txtEstado" id="txtEstado" readonly />
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="form-group">				
					...
					<input type="text" class="form-control input-sm" title="Area" name="txtTipoConsumo" id="txtTipoConsumo" readonly />					
				</div>
			</div>		
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<div class="form-group">				
					...
					<input type="text" class="form-control input-sm" title="Dia de la Semana" name="txtDiaSemana" id="txtDiaSemana" readonly />
				</div>
			</div>
			...
			<div class="col-sm-5">
				<div class="form-group">				
					...
					<input type="text" class="form-control input-sm" title="Motivo Investigacion" name="txtMotivoInvestigar" id="txtMotivoInvestigar" readonly />
				</div>
			</div>
			...
			<div class="col-sm-5">				
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<button id="investigar" title="Enviar Consumo a Investigar" type="submit" class="btn btn-block btn-xs btn-success" onclick="resultadoInvestigacionHogar();"><i class="fas fa-check fa-2x"></i></button>
					</div>					
...
<script src="investigar/funcionesV1.js"></script>
