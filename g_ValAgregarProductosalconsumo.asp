...
<%
'
' g_ValAgregarProductosalConsumo.asp // 08-ene-21 - 22mar21
'
...
idMarcaCubito= Request.Form("marcacubito")
...
unidadEmp	 = Request.Form("unidades")
'
tipoCodigo	=	"Manual"
sNuevoReg 	=	"G"
bValidado  	=	1
...
'	
IF idMarcaCubito = null or idMarcaCubito = "" THEN 
	idMarcaCubito = 0 
END IF
'
IF idCategoria = null or idCategoria = "" THEN 
	idCategoria = 0 
END IF
'
TotalCompra = 0
if idCategoria = 9 then
	TotalCompra = ( Precio * tasaCambio )
else
...
instSql = instSql & " IP, idsession, validado, Pendiente, Resuelto, Fecha_Creacion, Fec_ult_mod,"
instSql = instSql & " id_marca, unidad_empaque, Status_registro"
instSql = instSql & " )"
'
...
'
instSql = instSql & ""  & idMarcaCubito & ","
instSql = instSql & ""  & unidadEmp & ","
'
