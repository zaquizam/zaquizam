...
<%
'
' RetMen_llenar_cmb2.asp - 15jul21 - 13dic21
'
...
ELSEIF (Cint(opcion) = 8) THEN
	...
	' end if			
	' QrySql = QrySql & " AND"
	' QrySql = QrySql & " CodigoBarra IS NOT NULL AND CodigoBarra <> '' AND Descripcion IS NOT NULL AND Descripcion <> '' ORDER BY Descripcion"
	'
	'17nov	
	QrySql = vbnullstring	
	QrySql = QrySql & " SELECT"
