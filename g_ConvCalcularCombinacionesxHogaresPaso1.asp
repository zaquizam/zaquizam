...
<%
'
' g_ConvCalcularCombinacionesxHogaresPaso1.asp - 29abr21 - 
'
Session.lcid = 1034
...
SUB Calcular_Refrescos_250	
	...
	" AND PH_DataCrudaMensual.TAMANO = 250 " & _ 
	" GROUP BY" & _ 
	" PH_DataCrudaMensual.Id_Hogar," & _
	" PH_DataCrudaMensual.Id_Categoria" & _
	" HAVING" & _ 
	...
	if rsx1.eof then
		...
		tRefresco250_250  = 0
		tRefresco250_320  = 0 : tRefresco250_350  = 0 : tRefresco250_355  = 0
		tRefresco250_500  = 0 : tRefresco250_600  = 0 : tRefresco250_1000 = 0
		tRefresco250_1500 = 0 : tRefresco250_2000 = 0 : tRefresco250_2500 = 0	
		'	
	else		
		'Erase dataArray
		...
		" HAVING" & _
		" PH_DataCrudaMensual.Id_Categoria = 1"  & _
		" AND PH_DataCrudaMensual.Id_Hogar IN ( "  & Hogares & ")" & _
		" ORDER BY" & _
		" PH_DataCrudaMensual.Id_Hogar;" 
		'
		...
		if total250 > 0 then
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 320" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 350" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 355" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 500" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar," & _
			" PH_DataCrudaMensual.Tamano," & _
			" PH_DataCrudaMensual.Id_Categoria" & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 600" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 1000" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 1250" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 1500" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 2000" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
			...
			" PH_DataCrudaMensual.Id_Fabricante <> 0" & _
			" AND PH_DataCrudaMensual.Id_Semana IN (" & idMeses & ")" & _
			" AND PH_DataCrudaMensual.Tamano = 2500" & _
			" GROUP BY" & _
			" PH_DataCrudaMensual.Id_Hogar,"  & _
			" PH_DataCrudaMensual.Tamano,"  & _
			" PH_DataCrudaMensual.Id_Categoria"  & _
...
SUB Calcular_Refrescos_320
	...
	if rsx1.eof then
		...
		tRefresco320_250  = 0
		tRefresco320_320  = 0 : tRefresco320_350  =  0 :  tRefresco320_355  = 0 
		tRefresco320_500  = 0 :  tRefresco320_600  = 0 :  tRefresco320_1000 = 0 
		tRefresco320_1500 = 0 :  tRefresco320_2000 = 0 :  tRefresco320_2500 = 0 
		'
	else
		'Erase dataArray
		dataArray = rsx1.GetRows
...
SUB Calcular_Refrescos_350
	...
	if rsx1.eof then
		...
		tRefresco350_250  = 0
		tRefresco350_320  = 0 :  tRefresco350_350  = 0 : tRefresco350_355  = 0
		tRefresco350_500  = 0 :  tRefresco350_600  = 0 : tRefresco350_1000 = 0
		tRefresco350_1500 = 0 :  tRefresco350_2000 = 0 : tRefresco350_2500 = 0	
		'	
	else	
		'
		dataArray = rsx1.GetRows
...
SUB Calcular_Refrescos_355
	...
	ELSE
		...
		tRefresco355_250  = 0
		tRefresco355_320  = 0 : tRefresco355_350  = 0 : tRefresco355_355  = 0
...
SUB Calcular_Refrescos_500
	...
	if rsx1.eof then		
		...
		tRefresco500_250  = 0 : tRefresco500_1250 = 0
		tRefresco500_320  = 0 : tRefresco500_350  = 0 : tRefresco500_355  = 0
		tRefresco500_500  = 0 : tRefresco500_600  = 0 : tRefresco500_1000 = 0
		tRefresco500_1500 = 0 : tRefresco500_2000 = 0 : tRefresco500_2500 = 0	
		'			
	else
		'Erase dataArray
		dataArray = rsx1.GetRows
...
SUB Calcular_Refrescos_600
	...
	if rsx1.eof then		
		...
		tRefresco600_250  = 0 : tRefresco600_1250 = 0
		tRefresco600_320  = 0 : tRefresco600_350  = 0 : tRefresco600_355  = 0
		tRefresco600_500  = 0 : tRefresco600_600  = 0 : tRefresco600_1000 = 0
		tRefresco600_1500 = 0 : tRefresco600_2000 = 0 : tRefresco600_2500 = 0	
		'			
	else
		dataArray = rsx1.GetRows
		rsx1.close
...
SUB Calcular_Refrescos_1000
	...
	if rsx1.eof then		
		...
		tRefresco1000_250  = 0
		tRefresco1000_320  = 0 : tRefresco1000_350  = 0 : tRefresco1000_355  = 0
		tRefresco1000_500  = 0 : tRefresco1000_600  = 0 : tRefresco1000_1000 = 0
		tRefresco1000_1250 = 0 : tRefresco1000_1500 = 0 : tRefresco1000_2000 = 0 : tRefresco1000_2500 = 0	
		'			
	else
		dataArray = rsx1.GetRows
		rsx1.close
...
SUB Calcular_Refrescos_1250
	...
	if rsx1.eof then		
		...
		tRefresco1250_250  = 0 : tRefresco1250_1250 = 0
		tRefresco1250_320  = 0 : tRefresco1250_350  = 0 : tRefresco1250_355  = 0
		tRefresco1250_500  = 0 : tRefresco1250_600  = 0 : tRefresco1250_1000 = 0
		tRefresco1250_1500 = 0 : tRefresco1250_2000 = 0 : tRefresco1250_2500 = 0	
		'			
	else
		'Erase dataArray
		dataArray = rsx1.GetRows
...
SUB Calcular_Refrescos_1500
	...
	if rsx1.eof then		
		...
		tRefresco1500_250  = 0
		tRefresco1500_320  = 0 : tRefresco1500_350  = 0 : tRefresco1500_355  = 0
		tRefresco1500_500  = 0 : tRefresco1500_600  = 0 : tRefresco1500_1000 = 0
		tRefresco1500_1250 = 0 : tRefresco1500_2000 = 0 : tRefresco1500_2500 = 0	
		'			
	else
		'Erase dataArray
		dataArray = rsx1.GetRows
...
SUB Calcular_Refrescos_2000
	'Response.write "<BR><br>CALCULAR 2000 ML<BR><BR>"
	'	
	...
	if rsx1.eof then		
		...
		tRefresco2000_250  = 0
		tRefresco2000_320  = 0 : tRefresco2000_350  = 0 : tRefresco2000_355  = 0
		tRefresco2000_500  = 0 : tRefresco2000_600  = 0 : tRefresco2000_1000 = 0
		tRefresco2000_1250 = 0 : tRefresco2000_2000 = 0 : tRefresco2000_2500 = 0	
		'			
	else
		'Erase dataArray
		dataArray = rsx1.GetRows
...
SUB Calcular_Refrescos_2500
	'Response.write "<BR><br>CALCULAR 2500 ML<BR><BR>"
	'	
	...
	if rsx1.eof then		
		...
		tRefresco2500_250  = 0
		tRefresco2500_320  = 0 : tRefresco2500_350  = 0 : tRefresco2500_355  = 0
		tRefresco2500_500  = 0 : tRefresco2500_600  = 0 : tRefresco2500_1000 = 0
		tRefresco2500_1250 = 0 : tRefresco2500_2000 = 0 : tRefresco2500_2500 = 0	
		'			
	else
		'Erase dataArray
		dataArray = rsx1.GetRows
