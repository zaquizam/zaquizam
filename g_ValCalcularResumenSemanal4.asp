...
<%
	' g_ValCalcularResumenSemanal.asp // 09ene21 - 18ene21
	'
	Session.lcid = 1034
...
%>	
	<div class="form-horizontal">
		...
		<table class="table table-hover table-fixed table-striped table-condensed " cellspacing="0">		
			<thead>
			<tr>
				<th colspan="3" class="text-center info">Sem: <%=Semana%> </th>
				<th class="default"></th>
				<th colspan="3" class="text-center info">Sem: <%=Semana1%></th>
				<th class="default"></th>
				<th colspan="3" class="text-center info">Sem: <%=Semana2%></th>
			</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td class="text-center">% Variaci&oacute;n</td>
					<td class="info"></td>
					<td class="text-center">Monto</td>
					<td class="text-center">Unidades</td>
					<td class="text-center">% Variaci&oacute;n</td>
		...
		<table class="table table-hover table-fixed table-striped table-condensed" cellspacing="0">		
			<thead>
			<tr>
				<th colspan="3" class="text-center info">Sem: <%=Semana3%> </th>
				<th class="default"></th>
				<th colspan="3" class="text-center info">Sem: <%=Semana4%></th>
			</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
					...
					<td class="text-center"><%=FormatNumber(variacion3,0)%></td>
					<td class="info"></td>
					<td class="text-center"><%=FormatNumber(precio4,2)%></td>
					<td class="text-center"><%=FormatNumber(cantidad4,0)%></td>
					<td class="text-center"><%=FormatNumber(variacion4,0)%></td>
				</tr>               
			</tbody>
		</table>
