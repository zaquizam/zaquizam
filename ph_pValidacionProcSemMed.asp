...
%>
	...
	function Procesar(){
		...
		Sem =document.getElementById("Semana").value;
		//alert("Llego Cat:=" + Cat);
		//alert("Sem:=" + Sem);
		//return;
		var stodo = "cat=" + Cat + "&sem=" + Sem;
		document.getElementById("Programa").value = "g_ProcesamientoSemanalMed.asp?" + stodo;
		//return;
		
		swal({
                title: "Desea Procesar esta Categoria en esa Semana?",
                text: "",
                type: "warning",
            ...
            function() {
				...
				$.ajax({
					url:'g_ProcesamientoSemanalMed.asp?'+stodo,
					...
					success:function(data){
						...
						$('#loader2').html('');
						console.log(data); 
						swal("Procesamiento Semanal","Categoria Procesada","success");
...
%>
	...
	if idSemana <> "Seleccionar" and  idCategoria <> "Seleccionar" then
		...
		%>
		<input type="hidden" name="Semana" id="Semana" value="<%=idSemana%>" align="right" size=5>
