	...
	if rsx1.eof then
		...
		<table>
			<tr class="row100 head">
				<td class="cell100 column1 text-left">Área</td>
				<td class="cell100 column2 text-left">Fabricante</td>
				<td class="cell100 column3 text-center">Marca</td>
				<td class="cell100 column4 text-center">Segmento</td>
				<td class="cell100 column5 text-center">Rango Tamaño</td>
				<td class="cell100 column6 text-center">Tamaño</td>
				<td class="cell100 column7 text-center">Indicador</td>
				<td class="cell100 column8 text-center">UniMed</td>
				<%	
			...
			<tr class="row100 head">
				...
				<%	
					for iMes = 0 to  ubound(gMeses,2) 
						sx = gMeses(1,iMes) 
						%>
						<td class="cell100 column9 text-center"><%=sx%></td>
						<% 
					next 
					if ubound(gMeses,2) = 0 then
						%>
						<td class="cell100 column10 text-center"></td>
						<% 
					end if
				%>
			</tr>
