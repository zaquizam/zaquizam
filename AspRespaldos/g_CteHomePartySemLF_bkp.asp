						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column4 text-center">Rango Tama&ntilde;o</th>
							...
							<tbody>					
								<% for iPro = 0 to  ubound(gProductos,2)
									...
									response.write "<tr class='row100 body'>"
										...
										response.write "</td>"
										'Marca
										response.write "<td class='cell100 column2 text-center'>"
											if sMar <> "" then
												response.write gProductos(3,iPro)
											end if
										response.write "</td>"
										'Segmento
										response.write "<td class='cell100 column3 text-center'>"
											if sSeg <> "" then
												response.write gProductos(5,iPro)
											end if
										response.write "</td>"
										'Rango
										response.write "<td class='cell100 column4 text-center'>"
											if sRan <> "" then
									...
									for iInd = 0 to  ubound(gIndicadores,2)
										response.write "<tr class='row100 body'>"
											...
											response.write "</td>"
											response.write "<td  class='cell100 column6 text-center'>"
												response.write "<b>"
												response.write gIndicadores(1,iInd)
												response.write "</b>"
											response.write "</td>"
											response.write "<td  class='cell100 column7 text-center'>"
												response.write "<b>"
											...
											idSemana = 16
											CalcularIndicador
											response.write "<td class='cell100 column8 text-center'>"
