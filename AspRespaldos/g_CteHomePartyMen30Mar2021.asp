					...
					<div class="table100 ver1 m-b-110">
							...
							<div class="table100-body js-pscroll">
								<table border=0>
									<tbody>					
										<% 
										'response.write "<br>517 ToatalArea:= " & TotalArea & "<br>"
										'response.write "<br>517 sAre:= " & sAre & "<br>"
										...
										if TotalArea = "SI" and sFab = "" and sMar = "" and sSeg = "" and sRan = "" and sTam = "" then 
											if iMostrar = 1 then response.write "<br>521 PasoLR2" & sFab
											'response.write "<br>386 Total Area"
											for iPro = 0 to  ubound(gProductosTotalNacional,2)
