...
<script type="text/javascript">
	function GenerarExcel()
	{
		...
		window.open("g_CteHomePartyMenMedExcel.asp?" + num,"_blank");
	}
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#submit').click(function() {
			...
			document.getElementById("Filtro").value = "g_CteHomePartyMenMed.asp?" + stodo;
			document.getElementById("Excel").value = stodo;
			//return;
			$('#DivHomePartyMen').html("");
			$.ajax({
				url:'g_CteHomePartyMenMed.asp?'+stodo,
