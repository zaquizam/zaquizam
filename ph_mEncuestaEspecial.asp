...
Sub ParDat
	...
	ed_sNomTab		="PH_EncuestaEspecial"
	ed_sNomInd		="Id_EncuestaEspecial"
...
' Titulo	
   ...
   ed_sCampo(02,0)="Cliente"
   ed_sCampo(03,0)="Fecha Desde"
   ed_sCampo(04,0)="Fecha Hasta"
   ed_sCampo(05,0)="Mensaje Inicio"
   ed_sCampo(06,0)="Mensaje Final"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(2,0)=  " SELECT id_Cliente, Cliente FROM  ss_Cliente WHERE Fec_Inactivo is Null"

	ed_Formato(00,0)="w3-col l1  w3-left w3-padding "
	ed_Formato(01,0)="w3-col l4  w3-left w3-padding "
	ed_Formato(02,0)="w3-col l2  w3-left w3-padding "
	ed_Formato(03,0)="w3-col l2  w3-left w3-padding "
	ed_Formato(04,0)="w3-col l2  w3-left w3-padding "
	ed_Formato(05,0)="w3-col l9  w3-left w3-padding "
	ed_Formato(06,0)="w3-col l9  w3-left w3-padding "
