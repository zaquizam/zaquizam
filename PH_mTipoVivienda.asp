...
Sub ParDat
	...
	ed_sNomTab		="PH_TipoVivienda"
	ed_sNomInd		="Id_TipoVivienda"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	'ed_sQue(1,0)=  " SELECT Id_Canal, Canal FROM  PH_Canal WHERE Fec_Inactivo is Null "
