...
Sub ParDat
	...
	ed_sNomTab		="PH_FormaPago"
	ed_sNomInd		="Id_FormaPago"
...
' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Moneda"
   ed_sCampo(02,0)="FormaPago"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(1,0)=  " SELECT Id_Moneda, Moneda FROM  PH_Moneda WHERE Fec_Inactivo is Null "
