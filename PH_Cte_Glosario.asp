		...
		<div id="DivHomePartySem">
			<div class="ex1">
				<table class="w3-table w3-striped w3-bordered w3-card-4 w3-small" style="width:1000px; margin-left:auto; margin-right:auto;margin-top:10px ">
					...
					<%
					for iPro = 0 to  ubound(gDatos1,2)
						
						response.write "<tr>"
							response.write "<td>"
								response.write gDatos1(0,iPro)
							response.write "</td>"
							response.write "<td>"
								response.write gDatos1(1,iPro)
							response.write "</td>"
							response.write "<td>"
								response.write gDatos1(2,iPro)
							response.write "</td>"
							'response.write "<td>"
							'	if gDatos1(3,iPro) then
							'		response.write "Si"
							'	else
							'		response.write "No"
							'	end if
