<script>
	...
	//**Inicio Registrar Mod
	function registrarmod(){
		//alert("Llego Registrar Mod");
		num = document.getElementById("IdPanelistaMod").value;
		//alert("Llego Registrar Mod");
		var mensajeerr="";
		var err=0;
		nombre1 = document.getElementById("PrimerNombreMod").value;
		nombre2 = document.getElementById("SegundoNombreMod").value;
		apellido1 = document.getElementById("PrimerApellidoMod").value;
		apellido2 = document.getElementById("SegundoApellidoMod").value;
		nacionalidad = document.getElementById("NacionalidadMod").value;
		cedula = document.getElementById("CedulaMod").value;
		celular1 = document.getElementById("CelularMod").value;
		estadocivil = document.getElementById("EstadoCivilMod").value;
		correo1 = document.getElementById("CorreoMod").value;
		parentesco = document.getElementById("ParentescoMod").value;
		fechanacimiento = document.getElementById("FechaNacimientoMod").value;
		sexo = document.getElementById("SexoMod").value;
		educacion = document.getElementById("EducacionMod").value;
		tipoingreso = document.getElementById("TipoIngresoMod").value;
		if(nombre1 == "")
		{
		...
		//alert("Todo:=" + stodo);
		$.ajax({
			url:'g_GrabarBloque02Mod.asp?'+stodo,
			...
			success:function(data){
				...
				//buscar_panelistas();
				document.getElementById("PrimerNombreMod").value = "";
				document.getElementById("SegundoNombreMod").value = "";
				document.getElementById("PrimerApellidoMod").value = "";
				document.getElementById("SegundoApellidoMod").value = ""; 
				document.getElementById("NacionalidadMod").value = 0;
				document.getElementById("CedulaMod").value = "";
				document.getElementById("CelularMod").value = "";
				document.getElementById("CorreoMod").value = "";
				document.getElementById("ParentescoMod").value = 0;
				document.getElementById("EstadoCivilMod").value = 0;
				document.getElementById("FechaNacimientoMod").value = "";
				document.getElementById("EdadMod").value = "";
				document.getElementById("SexoMod").value = 0;
				document.getElementById("EducacionMod").value = 0;
				document.getElementById("TipoIngresoMod").value = 0;
				buscar_panelistas();
				CierraModal();
			}
		})
	...
	function registrarinc(){
		...
		estadocivil = document.getElementById("EstadoCivilInc").value;
	...
	//**Inicio Buscar Educacion Mod
	function buscar_educacionmod(){
		//alert("Llego Educacion Mod");
		$.ajax({
			url:'g_BuscarEducacionMod.asp',
			beforeSend: function(objeto){
				$('#loader2').html('<img src="./images/ajax-loader2.gif"> cargando...!');
			...
			success:function(data){
				...
				$('#loader2').html('');
				console.log(data);
				$('#DivEducacionMod').html(data);
			}
		})
	}	
	//**Fin Buscar Educacion Mod

	//**Inicio Buscar TipoIngreso Mod
	function buscar_tipoingresomod(){
		//alert("Llego TipoIngreso Mod");
		$.ajax({
			url:'g_BuscarTipoIngresoMod.asp',
			beforeSend: function(objeto){
				$('#loader2').html('<img src="./images/ajax-loader2.gif"> cargando...!');
			...
			success:function(data){
				...
				$('#loader2').html('');
				console.log(data);
				$('#DivTipoIngresoMod').html(data);
			}
		})
	}	
	//**Fin Buscar TipoIngreso Mod
		...
		<div id="3" class="modalmask">
			<div class="modalbox movedown">
				...
				<fieldset class="det">
					...
					<!--hidden-->
					<input type="hidden" name="IdPanelistaMod" id="IdPanelistaMod" align="right" maxlength=6 size=6>
					<!--Bloque 1a-->
					<table id="customers"> 
						<tr>
							<th>Primer Nombre</th>
					...
					<table id="customers"> 
						...
						<tr>
							<td>
								<div id="DivEducacionMod" style="width:35%; float:left;">
									<script>buscar_educacionmod()</script>
								</div>
							</td>
							<td>
								<div id="DivTipoIngresoMod">
									<script>buscar_tipoingresomod()</script>
								</div>
							</td>
						</tr>
					</table>
...
<script>
	//**Inicio Eliminar Panelista
	function EliPanelista(id)
	{
		//debugger;		
		swal({
                title: "Desea Eliminar Este Panelista ?",
                text: "",
                type: "warning",
            ...
            function() {
                //
				//alert("Eliminar Panelista:="+id);
				var stodo = "num=" + id;
				//alert("Todo:=" + stodo);
				$.ajax({
					url:'g_EliminarPanelista.asp?'+stodo,
					beforeSend: function(objeto){
						$('#loader2').html('<img src="./images/ajax-loader2.gif"> cargando...!');
		...
		let ajax = {
		  ...
		  $.ajax({
			...
			success: function (data1, textStatus, jqXHR) {				
				...
				$("#EducacionMod").val(data1[0].Id_EducacionMod);
				$("#TipoIngresoMod").val(data1[0].Id_TipoIngresoMod);
				buscar_edadmod();
