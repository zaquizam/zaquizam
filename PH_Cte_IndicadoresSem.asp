...
Sub ParDat
	...
	ed_sNomTab		="PH_Indicadores"
	ed_sNomInd		="Id_Indicador"
...
' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Descripcion"
   ed_sCampo(02,0)="Definicion"
   ed_sCampo(03,0)="Abreviatura"
   ed_sCampo(04,0)="Unidad Medida"
   ed_sCampo(05,0)="Semanal?"
   ed_sCampo(06,0)="Mensual?"
   ed_sCampo(07,0)="Atenas?"
   'ed_sCampo(07,0)="Mes"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_Formato(01,0)="w3-col l10  w3-left w3-padding "
	ed_Formato(02,0)="w3-col l12  w3-left w3-padding "
