...
'==========================================================================================
	...
	'response.write "<br>84 LLEGO" & sTam
	'response.end
	...
	'response.write "<br>298 sZon:= " & sZon
	'response.write "<br>298 sCan:= " & sCan
	'response.write "<br>298 sFab:= " & sFab
	'response.write "<br>298 sMar:= " & sMar
	'response.write "<br>298 sSeg:= " & sSeg
	'response.write "<br>298 sTam:= " & sTam
	'response.write "<br>298 sPro:= " & sPro
	'Query
	sql = ""
    sql = sql & " SELECT "
	sql = sql & " Id_Area, "
	...
	'response.write "<br>271 sTam:= " & sTam
	'if sTam <> "" and sTam <> "0" and iTam <> 0 then
	if len(sTam) > 1 then
	...
	sql = sql & " Descripcion, "
	sql = sql & " id_Semana "
	if sAre = "0" and sZon = "0" and sCan = "0" and sFab = "0" and sMar = "0" and sSeg = "0" and sTam = "" and sPro <> "" then
