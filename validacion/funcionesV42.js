//
// funcionesV42.js // 26feb21 - 06abr21
//
function Reset() {
	//		
...
function buscarHogar() {
	...
	var idArea		=	$("#cboArea").val(); 
	var idSemana	=	$("#cboSemana").val();		
	var idMostrar 	=	$("#cboMostrarTipoValidacion").val();		
	//
	...
	//		
	$.ajax({		
		url: "g_ValBuscarHogarxArea.asp?id_Estado=" + idEstado + "&id_Semana=" + idSemana + "&id_Area=" + idArea + "&id_Mostrar=" + idMostrar,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarTipoConsumo() {
	...
	//		
	$.ajax({		
		url: "g_ValBuscarHogarxTipoConsumo.asp?id_Hogar=" + idHogar + "&id_Semana=" + idSemana + "&id_Mostrar=" + idMostrar,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarTotalDiaSemana() {
	...
	//		
	$.ajax({		
		url: "g_ValBuscarTotalConsumoxDiaSemana.asp?id_TipoConsumo=" + idTipConsumo + "&id_Hogar=" + idHogar + "&id_Semana=" + idSemana + "&id_Mostrar=" + idMostrar,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarDetalleDiaSemana() {
	...
	//		
	$.ajax({		
		url: "g_ValBuscarDetalleConsumoxDiaSemana.asp?id_Fecha=" + idFecha + "&id_Hogar=" + idHogar + "&id_Semana=" + idSemana + "&id_TipoConsumo=" + idTipConsumo + "&id_Mostrar=" + idMostrar,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarDetallexProductoFactura() {
	...
	.done(function(data) {
		...
		$("#idConsumoHogar").html('<strong>Detalle Productos: ('+idConsumo+ ')</strong>');		
		//				
	})
	/*Si la consulta Fallo*/
	.fail(function() {
...
//
$("#cboMostrarTipoValidacion").on('change', function() {
  	//alert( this.value );
	$("#cboTipoConsumo").find('option:not(:first)').remove();
  	$('#cboTotalxDiaSemana').find('option:not(:first)').remove();
	$('#cboDetallexDiaSemana').find('option:not(:first)').remove();
	$("#cboHogar").prop("selectedIndex", 0);
	Reset_Detalles();  
});
//
function buscarOtrasCategorias() {	
	//
	$.ajax({
		url: "g_ValBuscarLlenarCmbOtrosProductos.asp",
		type: "POST",
		cache: false,
		async: false,
		//data: ajax,
...
//
function buscarMarcasCubitos() {	
	//
	$.ajax({
		url: "g_ValBuscarLlenarCmbMarcaCubitos.asp",
		type: "POST",
		cache: false,
		async: false,
		//data: ajax,
