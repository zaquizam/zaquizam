//
// funcionesV26.js // 29dic20 - 21ene21 
//
function Reset() {
	//		
...
function buscarCategoria() {
	//debugger;
	//$("#loader").html("<img src='images/ajax_small.gif'> Buscando Categorias!");	
	$("#cargando").css("display", "block");
	//
	$.ajax({
...
function buscarTotalHogaresResueltos() {
	...
	$.ajax({
		...
		success: function (data) {
			...
			var total = ($('#cboConsumoInvestigado option').length) - 1
			$("#totalResueltos").html(total);		
			$("#cargando").css("display", "none");			
		},
  });
}
