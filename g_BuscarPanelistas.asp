				...
				<table class="w3-table w3-striped w3-bordered w3-card-4 w3-small" style="width:1000px; margin-left:auto; margin-right:auto;margin-top:10px ">
					...
					for iReg = 0 to ubound(gDatosSol,2)
						Response.write "<tr>"
							...
							Response.write "<td>" 
							%>
							<!--<a href="#3" title="Mofificar Panelista">-->
								<img src="images/PDF02.jpg"  style="margin-left:0px;" alt="Modificar" width="20px"' onclick="SelPanelista(<%=sx%>)"/>
								<!--<img src="images/PDF02.jpg"  style="margin-left:0px;" alt="Modificar" width="20px"' onclick=""/>-->
							<!--</a>-->
							<%
							Response.write "</td>"
							for ib = 1 to 14
							...
							Response.write "<td>" 
							%>
								<img src="images/no.png"  style="margin-left:0px;" alt="Eliminar" width="20px"' onclick="EliPanelista(<%=sx%>)"/>
							<%
							Response.write "</td>"
						Response.write "</tr>"
					next
