<!Doctype html>
<!-- PH_Cte_RetailScanning.asp - 12jul21 - 29oct21 -->
<html lang="es" >
<head>
	...
	%>
		...
		<div class="container-fluid" id="grad3" >
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					...
					-->
					<label class="control-label col-sm-offset-2 col-sm-3 lb" for="company"><i class="fas fa-print"></i>&nbsp;Reporte Histórico:</label>
					<div class="col-sm-6 col-md-6 separa">
				...
				<!-- Imagen -->
				<div class="col-sm-2 text-center" id="image">
					<img class="img-rounded"  src="images/logo/LogoRetailScanning2.png"/>
					<br>
					<div class="btn-group btn-group-sm " role="group">
  						<button type="button" id="BtnAplicarFiltro"  title="Procesar" type="submit" class="btn btn-success btn-xs"><i class="fas fa-check"></i>&nbsp;Procesar</button>
  						<button type="button" id="BtnExcel"  title="Exportar a Excel" type="submit" class="btn btn-primary btn-xs"><i class="fas fa-download"></i>&nbsp;Excel</button>
  						<button type="button" id="BtnBorrar"  title="Borrar filtros"  type="submit" class="btn btn-danger btn-xs"><i class="fas fa-recycle"></i>&nbsp;Borrar</button>
					</div>
		...
		<div class="container-fluid text-center text-primary" id="procesando" style="display:none;">
			...
			<!--<span ><img src="https://www.animatedimages.org/data/media/1215/animated-gear-image-0005.gif" border="0"
				...
				<span ><img src="images/atenas48.gif" border="0"><strong>&nbsp;Espere, procesando....!</strong></span>
...
<script src="retsemanal/js/funcionesV01.js"></script>
