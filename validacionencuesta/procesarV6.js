...
//
function totalHogares(cboPeriodo, cboArea ) {
	
    return $.ajax({
      //url: "http://localhost:3000/api/getTotalHogaresPeriodo/"+cboPeriodo+"",
	  url: sessionStorage.getItem("urlApi")+"getTotalHogaresPeriodo/"+cboPeriodo+"/"+cboArea+"",
      type: 'get',
...
function Totalizar(){
	...
	total = parseInt(sessionStorage.getItem("totalExcl_A")) + parseInt(sessionStorage.getItem("totalExcl_B")) + parseInt(sessionStorage.getItem("totalConviven"));	
	console.log('1'+ total);
	total= ( total / parseInt(sessionStorage.getItem("totalHogares")) ) * 100;		
	console.log('2'+ total);
	//	
...
function borrar_Variables(){		
	sessionStorage.removeItem("totalHogaresA");	
	sessionStorage.removeItem("totalExcl_A");
	sessionStorage.removeItem("arrayCatA");
	sessionStorage.removeItem("totalHogaresB");	
	sessionStorage.removeItem("totalExcl_B");
	sessionStorage.removeItem("arrayCatB");
	sessionStorage.removeItem("totalHogares");
	sessionStorage.removeItem("totalConviven");		
}