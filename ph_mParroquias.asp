...
Sub ParDat
	...
	ed_sNomTab		="ss_Parroquia"
	ed_sNomInd		="Id_Parroquia"
...
' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Pais/Estado"
   ed_sCampo(02,0)="Parroquia"
   'ed_sCampo(02,0)="Cod Periodo"
   'ed_sCampo(03,0)="Periodo"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	sql = sql & " ss_Pais.Pais+'/'+ss_Estado.Estado as PaisEstado"
	sql = sql & " FROM ss_Pais INNER JOIN ss_Estado ON ss_Pais.Id_Pais = ss_Estado.Id_Pais "
	sql = sql & " WHERE "
	sql = sql & " ss_Pais.Fec_Inactivo Is Null "
	sql = sql & " ORDER BY "
	sql = sql & " ss_Pais.Pais, "
	...
	ed_Formato(02,0)="w3-col l5  w3-left w3-padding "
	'ed_Formato(02,0)="w3-col l1  w3-left w3-padding "
	'ed_Formato(03,0)="w3-col l5  w3-left w3-padding "
