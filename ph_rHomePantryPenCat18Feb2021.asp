				...
				<table class="w3-table w3-striped w3-bordered w3-card-4 w3-small" style="width:1000px; margin-left:auto; margin-right:auto;margin-top:10px ">
					<thead>
						<tr class="w3-blue">
							<th>IdCategoria</th>
							<th>Categoria</th>
							<th>Penetración Enero 2021</th>
							<th>Penetración Febrero 2021</th>
							<th>Acumulado 2021</th>
						</tr>
					</thead>
					<%
					for iPro = 0 to  ubound(gCategoriasEne,2)
						
						response.write "<tr>"
							response.write "<td>"
								response.write gCategoriasEne(2,iPro)
							response.write "</td>"
							response.write "<td>"
								response.write gCategoriasEne(3,iPro)
							response.write "</td>"
							sql = ""
							sql = sql & " SELECT "
							sql = sql & " ss_Semana.IdMes, "
							...
							sql = sql & " PH_DataCruda.Id_Hogar "
							sql = sql & " HAVING "
							sql = sql & " PH_DataCruda.Id_Categoria = " & gCategoriasEne(2,iPro)
							sql = sql & " AND ss_Semana.IdMes = 1 "
							sql = sql & " AND ss_Semana.IdAno = 2021 "
