    		...
    		Response.write "<div class='card'>"
				...
				Response.write "<div class='card-header'>"
					...
					Response.write "<div class='row'>"
						Response.write "<div class='col col-md-6'>PRUEBAS Data</div>"
						Response.write "<div class='col col-md-6 text-right'>"
							Response.write "<button type='button' id='export_button' class='btn btn-success btn-sm'>Exportar Excel</button>"
						Response.write "</div>"
					Response.write "</div>"
    			...
    			Response.write "<div class='card-body'>"	
					...
					Response.write "<div class='table-responsive'>"
						...
						Response.write "<table id='tbl_exporttable_to_xls' class='table table-striped table-hover table-condensed'>"
							...
							Response.write "<thead>"
								...
								Response.write "<tr>"
									...
									Response.write "<th class='text-center'>Tamano</th>"
