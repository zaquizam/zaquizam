...
'==========================================================================================
	...
	sql = ""
	sql = sql & " SELECT "
	sql = sql & " id_OcupacionVivienda, "
	sql = sql & " OcupacionVivienda "
	sql = sql & " FROM "
	sql = sql & " PH_OcupacionVivienda "
	sql = sql & " ORDER BY "
	sql = sql & " id_OcupacionVivienda "
	...
	<div id="DivOcupacionVivienda"> 
		<select name="OcupacionVivienda" id="OcupacionVivienda" onchange="validaocupacion()" >
