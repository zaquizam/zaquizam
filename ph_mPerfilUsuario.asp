...
Sub ParDat
	...
	ed_sNomTab		="ss_PerfilUsuario"
	ed_sNomInd		="Id_PerfilUsuario"
...
' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Perfil Usuario"
   ed_sCampo(02,0)="Link Acceso"
   ed_sCampo(03,0)="Ocutar"
   ed_sCampo(04,0)="Mostrar"
   ed_sCampo(05,0)="Grupo"
   ed_sCampo(06,0)="Descripcion"
   ed_sCampo(07,0)="Empresa"
   ed_sCampo(08,0)="Cliente?"
   ed_sCampo(09,0)="Operaciones"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(7,0)=  " SELECT Id_Empresa, Empresa FROM  ss_Empresa WHERE Fec_Inactivo is Null "
	...
	ed_Formato(04,0)="w3-col l12  w3-left w3-padding "
	...
	ed_Formato(08,0)="w3-col l1  w3-left w3-padding "
	ed_Formato(09,0)="w3-col l1  w3-left w3-padding "
End Sub
    LeePar
