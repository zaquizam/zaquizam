...
<html >
<head>
	<title>Actualizar Valores en data Cruda</title>
...
%>
	...
	function Procesar(){
		...
		//return;
		var stodo = "cat=" + Cat;
		document.getElementById("Programa").value = "g_ActualizarValoresDataCruda.asp?" + stodo;
		//return;
		
		swal({
                title: "Desea Actualizar los Valores de DataCruda en esta Categoria",
                text: "",
                type: "warning",
            ...
            function() {
				...
				$.ajax({
					url:'g_ActualizarValoresDataCruda.asp?'+stodo,
					...
					success:function(data){
						...
						$('#loader2').html('');
						console.log(data); 
						swal("Actualizar Valores en DataCruda","Categoria Procesada","success");
