...
<html >
<head>
	<title>Home Pantry Trimestral Med</title>
...
<script type="text/javascript">
	function GenerarExcel()
	{
		...
		window.open("g_CteHomePartyTriMedLRExcel.asp?" + num,"_blank");
	}
...
Sub Combos
	...
	sql = sql & " WHERE "
	sql = sql & " PH_CB_Categoria.Ind_Medicina = 1 "
	if idCliente <> 1 then
...
%>
	...
	<div class="container-fluid" id="grad1">  
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					<!--Rango Tamaño-->
				 	<label for="rango"><i class="fas fa-gopuram"></i>&nbsp;Presentación:</label>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#submit').click(function() {
			...
			document.getElementById("Filtro").value = "g_CteHomePartyTriLR.asp?" + stodo;
			document.getElementById("Excel").value = stodo;
			//return;
			$('#DivHomePartyMen').html("");
			$.ajax({
				url:'g_CteHomePartyTriMedLR.asp?'+stodo,
