	...
	<div class="container-fluid" id="grad1">  
        ...
        <div class="form-group"> 
	  		<table class="table no-margin">			
				<thead>
					<tr>
						<th class="text-center"><i class="fas fa-calculator"></i>&nbsp;Consumos:&nbsp;<span class="label label-info" id="totalConsumos">0</span></th>
						<th class="text-center"><i class="fas fa-check"></i>&nbsp;Validados:&nbsp;<span class="label label-success" id="totalValidados">0</span></th>
						<th class="text-center"><i class="fas fa-eye-slash"></i>&nbsp;Pendientes:&nbsp;<span class="label label-danger" id="totalPendientes">0</span></th>
						<th class="text-center"><i class="fas fa-calendar-check"></i>&nbsp;Alta Hogar:&nbsp;<span class="label label-warning" id="altaHogar"><i class="fas fa-calendar-day"></i></span></th>
					</tr>
				</thead>			
			</table>		 
		</div>
	...
	<div class="container-fluid" id="DetalleFactura" style="display:none;">
		...
		<div class="form-group-row">
			...
			<div class="col-sm-3">
				...
				<div class="form-group">
					<label class="control-label"><strong>Monto Factura:</strong></label>
					<div>
...
<script src="validacion/funcionesV9.js"></script>
<script src="validacion/crudV2.js"></script>
