...
<%
	' g_ValCalcularResumenSemanal.asp // 09ene21 - 20ene21
	'
	Session.lcid = 1034
	...
	'
	' Buscar nombre de la semana Actual
	'
	set rsSemana		=	CreateObject("ADODB.Recordset")
	rsSemana.CursorType	=	adOpenKeyset 
	rsSemana.LockType	=	2 'adLockOptimistic 	
...
%>	
	<div class="form-horizontal">
		...
		<table class="table table-hover table-fixed table-striped table-condensed " cellspacing="0">		
			<thead>
			<tr>
				<th colspan="7" class="text-center warning">VARIACION EN MONTOS</th>				
			</tr>
			</thead>
			<tbody>
				<tr>
		...
		<table class="table table-hover table-fixed table-striped table-condensed " cellspacing="0">		
			<thead>
			<tr>
				<th colspan="7" class="text-center warning">VARIACION EN UNIDADES</th>				
			</tr>
			</thead>
			<tbody>
				<tr>
