...
<script type="text/javascript">
	function GenerarExcel()
	{
		...
		window.open("g_CteHomePartySemEspExcel.asp?" + num,"_blank");
	}
...
Sub DataCombos
	...
	sql = sql & " Area "
	sql = sql & " FROM "
	sql = sql & " PH_DataCrudaSinMezcladores "
	sql = sql & " WHERE "
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#submit').click(function() {
			...
			document.getElementById("Filtro").value = "g_CteHomePartySemEsp.asp?" + stodo;
			document.getElementById("Excel").value = stodo;
			//return;
			$('#DivHomePartySem').html("");
			$.ajax({
				url:'g_CteHomePartySemEsp.asp?'+stodo,
