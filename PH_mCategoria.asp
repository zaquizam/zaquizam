...
Sub ParDat
	...
	ed_sNomTab		="PH_Categoria"
	ed_sNomInd		="Id_Categoria"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(3,0)=  " SELECT Id_UnidadMedida, UnidadMedida FROM  PH_UnidadMedida WHERE Fec_Inactivo is Null"
