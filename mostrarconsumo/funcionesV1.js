...
function Reset() {
	...
	$('#cboSemana').val(0);
	$("#cboSemana").focus();
	//$("#cboMostrarTipoValidacion").prop("selectedIndex", 0);	
}
//
...
function buscarArea() {		
	...
	//		
	$.ajax({			
		url: "g_MC_ValBuscarAreaxSemana.asp?id_Semana=" + idSemana,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarEstado() {	
	...
	//		
	$.ajax({			
		url: "g_MC_ValBuscarEstadoxArea.asp?id_Area=" + idArea + "&id_Semana=" + idSemana,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarHogar() {
	...
	var idArea		=	$("#cboArea").val(); 
	var idSemana	=	$("#cboSemana").val();		
	var idMostrar 	=	0; //$("#cboMostrarTipoValidacion").val();		
	//
	...
	//		
	$.ajax({		
		url: "g_MC_ValBuscarHogarxArea.asp?id_Estado=" + idEstado + "&id_Semana=" + idSemana + "&id_Area=" + idArea + "&id_Mostrar=" + idMostrar,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarTipoConsumo() {
	...
	//		
	$.ajax({		
		url: "g_MC_ValBuscarHogarxTipoConsumo.asp?id_Hogar=" + idHogar + "&id_Semana=" + idSemana + "&id_Mostrar=" + idMostrar,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarTotalDiaSemana() {
	...
	//		
	$.ajax({		
		url: "g_MC_ValBuscarTotalConsumoxDiaSemana.asp?id_TipoConsumo=" + idTipConsumo + "&id_Hogar=" + idHogar + "&id_Semana=" + idSemana + "&id_Mostrar=" + idMostrar,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarDetalleDiaSemana() {
	...
	//		
	$.ajax({		
		url: "g_MC_ValBuscarDetalleConsumoxDiaSemana.asp?id_Fecha=" + idFecha + "&id_Hogar=" + idHogar + "&id_Semana=" + idSemana + "&id_TipoConsumo=" + idTipConsumo + "&id_Mostrar=" + idMostrar,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarDetalleConsumoxDia() {
	...
	//		
	$.ajax({		
		url: "g_MC_ValBuscarDetalleConsumoxDia.asp?id_Consumo=" + idConsumo,
		cache: false,
		async: false,
		dataType: "json",
		beforeSend: function(objeto){
...
function buscarDetallexProductoFactura() {
	...
	var idConsumo 	 =	$("#cboDetallexDiaSemana").val();		
	var idTipConsumo =	$("#cboTipoConsumo").val();
	sUrl = "g_MC_ValBuscarDetallesxProductosxFactura.asp";	
	//
	let ajax = {
...
function buscarCadena(id) {
	...
	$.ajax({
		url: "g_MC_ValBuscarCadenaxConsumo.asp",
		type: "POST",
		cache: false,
		async: false,
		data: ajax,
...
function buscarCategoria() {
	...
	//
	$.ajax({
		url: "g_MC_ValBuscarLlenarCmbCategoria.asp",
		type: "POST",
		cache: false,
		async: false,
		//data: ajax,
...
function buscarMonedaPagoFactura() {		
	...
	//
	$.ajax({
		url: "g_MC_ValBuscarLlenarCmbMonedaPagoFactura.asp",
		type: "POST",
		cache: false,
		async: false,
		//data: ajax,
...
function buscarCambioTipoMonedaPago() {
	//debugger;
	// llenar combo para cambiar monesda de pago masivo
	//$("#loader").html("<img src='images/ajax_small.gif'> Buscando Moneda de Pago!");	
	$("#cargando").css("display", "block");
	//
	$.ajax({
		...
		dataType: "json",
		success: function (data) {
			let select = $("#cboCambioMonedaPago");
			select.find("option").remove();
			select.append("<option value='0' selected disabled> -- Seleccione -- </option>");
			$.each(data.data, function (key, value) {
				select.append("<option value=" + value.id + ">" + value.nombre + "</option>");
