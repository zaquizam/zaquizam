...
<%
	' g_ValBuscarLlenarCmbTipoMonedaPago.asp
	' 12ene21
	'
	Session.lcid=1034
	...
	QrySql = QrySql & " PH_Moneda.clave_busqueda as buscar,"
	...
	if IsArray(arrMoneda) then
		...
		For i = 0 to ubound(arrMoneda, 2)
			'
			sTabla     =  chr(123) &  chr(34) & "id" 	 & chr(34) & ":" & chr(34) & Cstr(arrMoneda(1,i)) & " - "  & Cstr(arrMoneda(0,i)) & chr(34) & chr(44)
			sTabla     =  sTabla   &  chr(34) & "nombre" & chr(34) & ":" & chr(34) & arrMoneda(2,i)       & chr(34) & chr(125) & chr(44)
