...
<script type="text/javascript">
	function enviarsms() 
	{
		...
		swal("Envio SMS","Enviado","success");
		//"phone":"584168254124",
...
%>
	...
	<div> 
		...
		<h4>
			<div id="DivCelular"> 
				Celular (4XXCCCCCCC)
				<input type="text" name="Celular" id="Celular" value="58" size=20 style="text-align:left; ">
			</div>
			<br>
			<div id="DivMensaje"> 
				Mensaje
				<textarea name="Mensaje" id="Mensaje" rows="8"  cols="100" style="height:200px;background-color:#9FCEED;"></textarea>
			</div>
			<br>
