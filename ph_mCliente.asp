...
Sub ParDat
	...
	ed_sNomTab		="ss_Cliente"
	ed_sNomInd		="Id_Cliente"
...
' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Empresa"
   ed_sCampo(02,0)="Cliente"
   ed_sCampo(03,0)="Direccion"
   ed_sCampo(04,0)="Telifono"
   ed_sCampo(05,0)="Rif"
   ed_sCampo(06,0)="Persona Contacto"
   ed_sCampo(07,0)="Url Logo"
   ed_sCampo(08,0)="Fax"
   ed_sCampo(09,0)="Activa?"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_Formato(03,0)="w3-col l4  w3-left w3-padding "
