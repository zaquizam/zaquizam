...
<%
	' g_rRevInvBuscarDetalleConsumoxDia.asp	// 14ene21
	'
	Session.lcid=1034
	...
	QrySql = QrySql & " PH_Consumo.id_tipoconsumo"
	QrySql = QrySql & " FROM"
	...
	if IsArray(arrDetalleConsumo) then
		...
		For i = 0 to ubound(arrDetalleConsumo, 2)
			...
			sTabla    =    sTabla &  chr(34) & "tipoconsumo"	& chr(34) & ":" & chr(34) & arrDetalleConsumo(8,i) & chr(34) & chr(44)
			'
