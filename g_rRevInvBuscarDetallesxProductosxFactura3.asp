...
<%
	' g_rRevInvBuscarDetallesxProductosxFactura.asp - // 14ene21
	'
	Session.lcid=1034
	...
	IF ( CInt(idTipoConsumo) = 1 or Cint(idTipoConsumo) = 8 ) THEN
		'	
		' Buscar Resultados Medicinas -  Mercado Reposicion
		'
					...
					<table class="table table-hover table-fixed table-striped table-condensed" cellspacing="0">		
						...
						<thead class="thead-light">
							...
							<tr>
								...
								<th class="text-center" title="Tipo Codigo">Tipo de Barras</th>
								...
								<th class="text-right"  title="Tasa de Cambio">Tasa de Cambio</th>
