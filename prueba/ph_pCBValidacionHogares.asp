<!Doctype html>
<!-- ph_pCBValidacionHogares - 28dic20 - 29ene21 -->
<html >
<head>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control input-sm text-right" id="txtId2" placeholder="...." readonly />
					</div>
...
<script src="validacion/crudV34.js"></script>
<script src="validacion/funcionesV34.js"></script>
<script src="validacion/funResueltoV34.js"></script>
