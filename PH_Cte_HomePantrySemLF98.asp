...
%>
	...
	<div class="form-group">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">				
					<label>Categoría:</label><span id="loader"></span>
		...
		<!--Borrar Filtros-->
			...
			<div class="col-sm-4">				
				<button type="button" title="Aplicar Selección" class="btn btn-block btn-sm btn-success" id="submit"> <i class="fas fa-check"></i>&nbsp;APLICAR SELECCIÓN</button>
				</div>
