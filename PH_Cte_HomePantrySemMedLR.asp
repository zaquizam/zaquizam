...
<html >
<head>
	<title>Home Pantry Semanal Med</title>
...
%>
	...
	<div class="container-fluid" id="grad1">  
			...
			<div class="col-sm-4">
				...
				<div class="form-group">
					<!--Fabricante-->	
					 <label for="fabricante"><i class="fas fa-pills"></i>&nbsp;Laboratorio:</label>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#submit').click(function() {
			...
			document.getElementById("Filtro").value = "g_CteHomePartySemMedLR.asp?" + stodo;
			document.getElementById("Excel").value = stodo;
			//return;
			$('#DivHomePartySem').html("");
			$.ajax({
				url:'g_CteHomePartySemMedLR.asp?'+stodo,
