...
'==========================================================================================
	...
	strSemana2 = "(05) Del 01 Feb 2021 al 07 Feb 2021"
	strSemana3 = "(06) Del 08 Feb 2021 al 14 Feb 2021"
	strSemana4 = "(07) Del 15 Feb 2021 al 21 Feb 2021"
	strSemana5 = "Acumulado Feb 2021"
	...
	sql = sql & " FROM PH_DataCrudaSinMezcladores "
...
Sub CalcularIndicador
	Select Case Indicador
		...
		Case 5 'PenNum
			...
			sql = sql & " And id_Semana in( " & idSemana & ")"
			sql = sql & " GROUP BY "
			sql = sql & " PH_DataCrudaSinMezcladores.Id_Hogar "
			'response.write "<br>36 sql:=" & sql
			'response.end
			rsx1.Open sql ,conexion
			'response.write "<br>257 LLEGO" 
