...
' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Menu"
   ed_sCampo(02,0)="Nivel"
   ed_sCampo(03,0)="Orden"
   ed_sCampo(04,0)="Perfil"
   ed_sCampo(05,0)="Link"
   ed_sCampo(06,0)="Tool Tips"
   ed_sCampo(07,0)="Activo?"
   ed_sCampo(08,0)="Target"
   ed_sCampo(09,0)="Parametros"
   ed_sCampo(10,0)="Empresa"
   ed_sCampo(11,0)="Grupo"
   ed_sCampo(12,0)="Oculto?"
   ed_sCampo(13,0)="Icono"
   ed_sCampo(14,0)="Ruta"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	'ed_sQue(1,0)=  " SELECT Id_Empresa, Empresa FROM  ss_Empresa WHERE Fec_Inactivo is Null "
	...
	ed_Formato(05,0)="w3-col l4  w3-left w3-padding "
	ed_Formato(06,0)="w3-col l4  w3-left w3-padding "
	...
	ed_Formato(10,0)="w3-col l1  w3-left w3-padding "
