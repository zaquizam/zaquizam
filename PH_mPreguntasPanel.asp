...
Sub ParDat
	...
	ed_sNomTab		="PH_PreguntasPanel"
	ed_sNomInd		="Id_PreguntaPanel"
...
' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Panel"
   ed_sCampo(02,0)="Pregunta"
   ed_sCampo(03,0)="Tipo Pregunta"
   ed_sCampo(04,0)="Respuestas"
   ed_sCampo(05,0)="Activo?"
   ed_sCampo(06,0)="Semana Desde"
   ed_sCampo(07,0)="Semana Hasta"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(1,0)=  " SELECT Id_Panel, Panel FROM  PH_Paneles WHERE Fec_Inactivo is Null "
	ed_sQue(3,0)=  " SELECT Id_TipoPregunta, TipoPregunta FROM  ss_TipoPregunta WHERE Fec_Inactivo is Null "
	ed_sQue(6,0)=  " SELECT Id, Semana FROM  ss_Semana WHERE Fec_Inactivo is Null "
	ed_sQue(7,0)=  " SELECT Id, Semana FROM  ss_Semana WHERE Fec_Inactivo is Null "
	...
	ed_Formato(04,0)="w3-col l6  w3-left w3-padding "
