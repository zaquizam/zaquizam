...
%>
	...
	if idSemana <> "Seleccionar" and  idCategoria <> "Seleccionar" and  idProducto <> "Seleccionar" then
		...
		%>
		<input type="hidden" name="Programa" id="Programa" value="<%=sPar%>" align="right" size=200>
						...
						for iReg = 0 to ubound(gDatosSol,2)
							...
							Response.write "<tr>"
								...
								if Mostrar = 1 then 
									Response.write "<td>" 
										%>
										<img src="images/Boton01.png"  style="margin-left:0px;" alt="Agregar" width="40px"' onclick="ActualizarPromedio(<%=sx%>)"/>
										<%
									Response.write "</td>" 
									Response.write "<td>" 
										%>
										<img src="images/Boton02.png"  style="margin-left:0px;" alt="Agregar" width="40px"' onclick="ActualizarModa(<%=sx%>)"/>
										<%
									Response.write "</td>" 
								else
									Response.write "<td>" 
								...
								Response.write "<td>" 
									%>
									<img src="images/Boton03.png"  style="margin-left:0px;" alt="Agregar" width="40px"' onclick="ActualizarManual(<%=sx%>)"/>
									<%
								Response.write "</td>"
								Response.write "<td>" 
								sx1 = "Manual" & sx 
								...
								Response.write "<td>" 
									%>
									<img src="images/Boton03.png"  style="margin-left:0px;" alt="Agregar" width="40px"' onclick="ActualizarManualCantidad(<%=sx%>)"/>
									<%
								Response.write "</td>"
								Response.write "<td>" 
