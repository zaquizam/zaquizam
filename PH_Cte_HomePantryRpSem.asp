<!Doctype html>
<!-- PH_Cte_HomePantryRpSem.asp - 02feb22 - 09feb22 -->
<html lang="es" >
<head>
	<title>| HP Reporte Semanal |</title>
	<meta charset="UTF-8">
	...
	<link href="repsemanalhp/css/hprepsemanal.css"  rel="stylesheet" type="text/css" />
	<link href="css/bootstrap-multiselect-0915.css" rel="stylesheet" >
	<link href="css/bootstrap.min.css" rel="stylesheet" type="text/css" />
	<link href="repsemanalhp/css/hptablasem.css" rel="stylesheet" type="text/css" >	
...
<body topmargin="0">
	...
	%>
		...
		<div class="container-fluid text-center text-primary" id="DivHomePantrySem" style="display:none;" >
...
<script src="repsemanalhp/js/funcionesHpSem.js"></script>
<script src="repsemanalhp/js/refillCombosHpSem.js"></script>
...
<script>
	...
	$(function () {
		...
		$('#BtnAplicarFiltro').click(function() {
			...
			bLoquear();
			//
			$("#DivHomePantrySem").css("display", "none");	
			...
			.done(function(data) {				
				...
				console.log(data);
				$('#DivHomePantrySem').html('');
				$('#DivHomePantrySem').html(data);
				$("#procesando").css("display", "none");
				$("#DivHomePantrySem").css("display", "block");
...
//console.log(scripts);
var toRefreshs = ['funcionesSemHp.js', 'refillCombosSemHp.js, hptablasem.css']; // list of js to be refresh
