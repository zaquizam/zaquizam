...
<html >
<head>
	<title>Home Pantry Mensual Med</title>
...
<script type="text/javascript">
	function GenerarExcel()
	{
		...
		window.open("g_CteHomePartyMenMedLRExcel.asp?" + num,"_blank");
	}
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#submit').click(function() {
			...
			document.getElementById("Filtro").value = "g_CteHomePartyMenMedLR.asp?" + stodo;
			document.getElementById("Excel").value = stodo;
			//return;
			$('#DivHomePartyMen').html("");
			$.ajax({
				url:'g_CteHomePartyMenMedLR.asp?'+stodo,
