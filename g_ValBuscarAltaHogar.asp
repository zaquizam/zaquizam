...
<%
	' g_ValBuscarAltaHogar.asp - 05ene21 - 06abr21 
	'
	Session.lcid = 1034
	...
	'		
	' if isnull(arrAltaHogar(0,0)) or Len(arrAltaHogar(0,0))=0 then			
		' Response.Write "Sin Registro"		
	' else
		' Response.Write arrAltaHogar(0,0)
	' end if	
	'
	...
	if IsArray(arrAltaHogar) then
		...
		For i = 0 to ubound(arrAltaHogar, 2)
			...
			sTabla    =    sTabla   &  chr(34) & "total"	& chr(34) & ":" & chr(34) & arrAltaHogar(4,i) & chr(34) & chr(44)
			'
