			...
			<div class="table100 ver1 m-b-110">
					...
					<div class="table100-head">
						...
						<table>
							<thead>
								<tr class="row">
									<th class="cell100 column1">Fabricante</th>
									<th class="cell100 column2">Marca</th>
									<th class="cell100 column3">Segmento</th>
									<th class="cell100 column4">Rango Tama&ntilde;o</th>
									<th class="cell100 column5">Indicador</th>
									<th class="cell100 column6">UniMed</th>
									<th class="cell100 column7"><%=strSemana1%></th>
									<th class="cell100 column8"><%=strSemana2%></th>									
								</tr>
							</thead>
						</table>
							...
							<tbody>					
								<% for iPro = 0 to  ubound(gProductos,2)
									...
									response.write "<tr class='row100 body'>"
										'Fabricante
										response.write "<td class='cell100 column1'>"
											response.write gProductos(1,iPro)
										response.write "</td>"
										'Marca
										response.write "<td class='cell100 column2'>"
											if sMar <> "" then
												response.write gProductos(3,iPro)
											end if
										response.write "</td>"
										'Sepmento
										response.write "<td class='cell100 column3'>"
											if sSeg <> "" then
												response.write gProductos(5,iPro)
											end if
										response.write "</td>"
										'Rango
										response.write "<td class='cell100 column4'>"
											if sRan <> "" then
									...
									for iInd = 0 to  ubound(gIndicadores,2)
										response.write "<tr class='row100 body'>"
											...
											response.write "</td>"
											response.write "<td  class='cell100 column6'>"
												response.write "<b>"
												response.write gIndicadores(1,iInd)
												response.write "</b>"
											response.write "</td>"
											response.write "<td  class='cell100 column7'>"
												response.write "<b>"
											...
											idSemana = 16
											CalcularIndicador
											response.write "<td style='text-align:right'  class='cell100 column8'>"
	...
	Select Case Indicador
		Case 1 'CompVol 
			if iFab <> 0 then
				...
				sql = sql & " And id_Semana = " & idSemana
			else
				sql = ""
				sql = sql & " SELECT "
				sql = sql & " Tamano, "
