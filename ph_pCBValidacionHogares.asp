			...
			<div class="col-sm-3">				
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
					  ...
					  <select class="form-control input-sm" id="cboMostrarTipoValidacion">
						  <option value="0" selected>Mostrar Todos</option>
						  <option value="1">Solo Pendientes</option>
						  <option value="2">Solo Validados</option>
					  </select>
					</div>
	...
	<div class="container-fluid" id="DetalleFactura" style="display:none;">
		...
		<div class="form-group-row">
			...
			<div class="col-sm-9">					
				...
				<h4 class="text-danger" id="idConsumoHogar"></h4>
		...
		<div class="modal-dialog modal-dialog-centered"  role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<div class="form-group" id="showOtrosProductos" style="display: none;">
							<label class="control-label text-primary" for="cboOtrosProductos">Categoria:</label>							
							<select class="form-control input-sm" name="cboCategoriaOtros" id="cboCategoriaOtros" required />
								<option value="0" selected disabled >-- Seleccione -- </option>								
							</select>
						</div>
						
						<!-- Mostrar Marca cubitos -->
						<div class="form-group" id="showCubitos" style="display: none;" >
							<label class="control-label text-primary" for="cboMarcasCubitos">Marca:</label>
							<select class="form-control input-sm" name="cboMarcaCubitos" id="cboMarcaCubitos" required />
								<option value="0" selected disabled >-- Seleccione -- </option>									
							</select>
							<div class="error" id="cubitoErr"></div>							
						</div>
																		
						<div class="form-group" id="MasterProductos" style="display:none;">	
						...
						<div class="form-group" id="showUnidades" style="display: none;">
							<label class="control-label text-primary" for="cantidad">Unidades por Empaque:</label>
							<input type="number" id="unidades" name="unidades" class="form-control input-sm" placeholder="..." step="1" required />                                            
							<div class="error" id="unidadesErr"></div>
						</div>
						
						<div class="form-group">
							 <label class="text-primary" id="nombreCantidad" >Cantidad:</label>
						...
						<div class="form-group">
							 <label class="text-primary" id="nombrePrecio">Precio Unitario:</label>
