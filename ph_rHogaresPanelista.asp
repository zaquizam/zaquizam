...
<html >
<head>
	<title>Reporte Hogares/Panelista</title>
...
'ed_ides=1
	...
	sqlcla = sqlcla & " PH_Ciudad.Ciudad, "
	...
	sqlcla = sqlcla & " PH_PanelHogar.Ind_Perro, "
	sqlcla = sqlcla & " PH_PanelHogar.Ind_Gato, "
	sqlcla = sqlcla & " PH_PanelHogar.Ind_Pez, "
	sqlcla = sqlcla & " PH_PanelHogar.Ind_Perro, "
	...
	sqlcla = sqlcla & " FROM ((((((PH_PanelHogar INNER JOIN ss_Estado ON PH_PanelHogar.Id_Estado = ss_Estado.Id_Estado) INNER JOIN ss_Municipio ON PH_PanelHogar.Id_Municipio = ss_Municipio.Id_Municipio) INNER JOIN ss_Parroquia ON PH_PanelHogar.Id_Parroquia = ss_Parroquia.Id_Parroquia) INNER JOIN PH_Ciudad ON PH_PanelHogar.Id_Ciudad = PH_Ciudad.Id_Ciudad) LEFT JOIN PH_Panelistas ON PH_PanelHogar.Id_PanelHogar = PH_Panelistas.Id_Hogar) LEFT JOIN PH_Parentesco ON PH_Panelistas.Id_Parentesco = PH_Parentesco.Id_Parentesco) LEFT JOIN PH_Banco ON PH_Panelistas.Id_Banco = PH_Banco.Id_Banco " 
