...
Sub ParDat
	...
	ed_sNomTab		="PH_GAreaEstado"
	ed_sNomInd		="Id_AreaEstado"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(1,0)=  " SELECT Id_Area, Area FROM  PH_GArea WHERE Fec_Inactivo is Null"
	ed_sQue(2,0)=  " SELECT Id_Estado, Estado FROM  ss_Estado WHERE Fec_Inactivo is Null"
