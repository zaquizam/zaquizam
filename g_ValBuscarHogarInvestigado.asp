...
<%
	' g_ValBuscarHogarInvestigado.asp // 10ene21 - 14ene21
	'
	Session.lcid=1034
	...
	strSQLscroll = "SELECT enviado_investigar, id_consumo FROM PH_Consumo WHERE enviado_investigar=1 AND Resuelto=0 and Id_Consumo =" & idConsumo
