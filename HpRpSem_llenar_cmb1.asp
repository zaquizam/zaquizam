...
<%
'
'RetSem_llenar_cmb1.asp - 12jul21 - 27ene22
'
...
IF (Cint(opcion) = 1) THEN
	...
	ELSE
		...
		' QrySql = QrySql & " RS_DataProcSem.Id_Categoria AS id,  "
		' QrySql = QrySql & " RS_DataProcSem.Categoria AS nombre "		
		' QrySql = QrySql & " FROM dbo.RS_DataProcSem"
		...
		' QrySql = QrySql & " and ss_ClienteCategoria.Ind_Semanal = 1 "
		' QrySql = QrySql & " GROUP BY RS_DataProcSem.Id_Categoria, "
		' QrySql = QrySql & " RS_DataProcSem.Categoria "
...
ELSEIF (Cint(opcion) = 11) THEN
	...
	if Cint(idCliente=1) then
		...
		' QrySql = vbnullstring		
		' QrySql = " SELECT ss_ClienteCategoria.Id_semanaDesde AS desde, ss_ClienteCategoria.Id_semanaPub AS hasta FROM ss_ClienteCategoria"
		' QrySql = QrySql & " WHERE"
		' QrySql = QrySql & " ss_ClienteCategoria.Id_Cliente = " & idCliente
		' QrySql = QrySql & " AND"
		' QrySql = QrySql & " ss_ClienteCategoria.Ind_semanal = 1"
		' QrySql = QrySql & " AND"
		' QrySql = QrySql & " ss_ClienteCategoria.Id_Categoria = " & idCat
		'27ene22
		QrySql = vbnullstring		
		QrySql = " SELECT ss_ClienteCategoria.Id_semanaDesde AS desde, ss_ClienteCategoria.Id_semanaPub AS hasta FROM ss_ClienteCategoria WHERE ss_ClienteCategoria.Id_Cliente = " & idCliente & " AND ss_ClienteCategoria.Ind_semanal = 1 AND ss_ClienteCategoria.Id_Categoria = " & idCat
...
ELSEIF (Cint(opcion) = 12) THEN	
	...
	if (CInt(idCliente) = 1) then
		...
		QrySql = vbnullstring		
		QrySql = " SELECT COUNT(Id_Cliente) as total FROM dbo.ss_ClienteCategoria WHERE dbo.ss_ClienteCategoria.Id_Cliente = " & idCliente & " AND dbo.ss_ClienteCategoria.Ind_semanal = 1"
		'
		'Response.Write QrySql & "<BR><BR>"
		'Response.end
		'
...
ELSEIF (Cint(opcion) = 13) THEN
	...
	if Cint(idCliente=1) then
		...
		QrySql = vbnullstring		
		QrySql = QrySql & " SELECT ss_ClienteCategoria.Id_semanaDesde AS desde, ss_ClienteCategoria.Id_semanaPub AS hasta FROM ss_ClienteCategoria"
		QrySql = QrySql & " WHERE ss_ClienteCategoria.Id_Cliente = " & idCliente
		QrySql = QrySql & " AND ss_ClienteCategoria.Ind_semanal = 1 AND ss_ClienteCategoria.Id_Categoria = " & idCat
	end if
	'
	' Response.Write QrySql & "<BR><BR>"
	' Response.end
