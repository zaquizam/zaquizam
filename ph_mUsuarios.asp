...
Sub ParDat
	...
	ed_sNomTab		="ss_Usuarios"
	ed_sNomInd		="Id_Usuario"
...
'ed_ides=1
	...
	sqlcla = sqlcla & " And Id_Usuario >2 "
	'response.write "<br>47 Perfil:= " & Session("idPerfil")
	

' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Correo"
   ed_sCampo(02,0)="Clave"
   ed_sCampo(03,0)="Nombres"
   ed_sCampo(04,0)="Apellidos"
   ed_sCampo(05,0)="PerfilUsuario"
   ed_sCampo(06,0)="Cliente"
   ed_sCampo(07,0)="Activo?"
   ed_sCampo(15,0)="Area"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(6,0)=  " SELECT id_Cliente, Cliente FROM  ss_Cliente WHERE Fec_Inactivo is Null"
	ed_sQue(15,0)=  " SELECT id_Area, Area FROM  ss_Area "

	ed_Formato(00,0)="w3-col l1  w3-left w3-padding "
	ed_Formato(01,0)="w3-col l5  w3-left w3-padding "
...
if ed_iPas = 2 then
	%>
	<!--
	<h5 class="text-center"><strong>Para que los cambios surtan efecto,</strong></h5>
	<h5 class="text-center"><strong>debe salir de la web y volver a entrar </strong></h5>
	<h5 class="text-center"><strong>una vez guardado el registro</strong></h5>-->
	<%
end if	
