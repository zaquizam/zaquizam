<!Doctype html>
<!-- PH_Cte_RetailScanning.asp - 12jul21 - 06dic21 -->
<html lang="es" >
<head>
...
<!--<body topmargin="0" class="loading">-->

<!--<body topmargin="0" onload="loader();">-->
...
<script src="rsrepsemanal/js/refillCombosSemV02.js"></script>
