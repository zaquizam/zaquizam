...
Sub ParDat
	...
	ed_sNomTab		="PH_Medio_Delivery"
	ed_sNomInd		="Id_Medio_Delivery"
...
'ed_ides=1
	...
	sqlcla = sqlcla & " and id_medio_delivery > 0 "
	'response.write "<br>47 Perfil:= " & Session("idPerfil")
	

' Titulo	
   ed_sCampo(00,0)="#"
   ed_sCampo(01,0)="Medio"
   ed_sCampo(02,0)="Medio Delivery"
...
' Copiar
 '   ed_sCampo(3,8)=2
  '  ed_sCampo(3,8)=2
	...
	ed_sQue(1,0)=  " SELECT Id_Medio, Medio FROM  PH_Medio WHERE id_Medio = 2 "
